...
import { getUser, listUsers, resetPassword, setUserStatus, type User, assertEmailAvailable, normalizePhone, assertPhoneAvailable } from './users.ts';
...
export function updateProfile(
  ...
  if (input.phone !== undefined) { const phone = normalizePhone(input.phone); assertPhoneAvailable(phone, userId); values.phone = phone; }
